...
<title>Customer Enrollment Signup</title>
...
<body>
	...
	<div class="navbar navbar-default">
		...
		<div class="navbar-collapse collapse navbar-responsive-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="/customerportal">Home</a></li>
	...
	<script src="${pageContext.request.contextPath}/resources/jquery/jquery-1.8.3.js">
	...
	<script src="${pageContext.request.contextPath}/resources/datepicker/js/bootstrap-datepicker.js">
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Welcome to Online Customer Enrollment Signup</h1>
	...
	<div class="col-lg-6 col-lg-offset-3">
		<div class="well">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<form:form id="myForm" method="post" class="bs-example form-horizontal" action="${pageContext.request.contextPath}/signup" commandName="customer">
							<fieldset>
								<legend>Customer Enrollment Signup Form</legend>
								...
								<div class="form-group">
									<label for="firstNameInput" class="col-lg-3 control-label">FirstName</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="email" id="emailAddressInput" placeholder="Email Address" />										
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="phone" id="phoneInput" placeholder="Phone" />
